...
@Component({
  selector: 'app-december-calendar',
  templateUrl: './december-calendar.component.html',
  styleUrls: ['./december-calendar.component.css'],
  providers: [TaskService]
})
export class DecemberCalendarComponent implements OnInit {
  day_1: Array<Object> = [];
  day_2: Array<Object> = [];
  day_3: Array<Object> = [];
  day_4: Array<Object> = [];
  ...
  ngOnInit(): void {
    this.getCategories();
    this.actualDay();
    this.getByDayAndMonth(1, 'December');
    this.getByDayAndMonth(2, 'December');
    this.getByDayAndMonth(3, 'December');
    this.getByDayAndMonth(4, 'December');
    this.getByDayAndMonth(5, 'December');
    this.getByDayAndMonth(6, 'December');
    this.getByDayAndMonth(7, 'December');
    this.getByDayAndMonth(8, 'December');
    this.getByDayAndMonth(9, 'December');
    this.getByDayAndMonth(10, 'December');
    this.getByDayAndMonth(11, 'December');
    this.getByDayAndMonth(12, 'December');
    this.getByDayAndMonth(13, 'December');
    this.getByDayAndMonth(14, 'December');
    this.getByDayAndMonth(15, 'December');
    this.getByDayAndMonth(16, 'December');
    this.getByDayAndMonth(17, 'December');
    this.getByDayAndMonth(18, 'December');
    this.getByDayAndMonth(19, 'December');
    this.getByDayAndMonth(20, 'December');
    this.getByDayAndMonth(21, 'December');
    this.getByDayAndMonth(22, 'December');
    this.getByDayAndMonth(23, 'December');
    this.getByDayAndMonth(24, 'December');
    this.getByDayAndMonth(25, 'December');
    this.getByDayAndMonth(26, 'December');
    this.getByDayAndMonth(27, 'December');
    this.getByDayAndMonth(28, 'December');
    this.getByDayAndMonth(29, 'December');
    this.getByDayAndMonth(30, 'December');
    this.getByDayAndMonth(31, 'December');
  }
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.taskService.deleteTask(id).subscribe(res => {
          ...
          // All days.. Again
          if (day === 1) this.getByDayAndMonth(1, 'December');
          if (day === 2) this.getByDayAndMonth(2, 'December');
          if (day === 3) this.getByDayAndMonth(3, 'December');
          if (day === 4) this.getByDayAndMonth(4, 'December');
          if (day === 5) this.getByDayAndMonth(5, 'December');
          if (day === 6) this.getByDayAndMonth(6, 'December');
          if (day === 7) this.getByDayAndMonth(7, 'December');
          if (day === 8) this.getByDayAndMonth(8, 'December');
          if (day === 9) this.getByDayAndMonth(9, 'December');
          if (day === 10) this.getByDayAndMonth(10, 'December');
          if (day === 11) this.getByDayAndMonth(11, 'December');
          if (day === 12) this.getByDayAndMonth(12, 'December');
          if (day === 13) this.getByDayAndMonth(13, 'December');
          if (day === 14) this.getByDayAndMonth(14, 'December');
          if (day === 15) this.getByDayAndMonth(15, 'December');
          if (day === 16) this.getByDayAndMonth(16, 'December');
          if (day === 17) this.getByDayAndMonth(17, 'December');
          if (day === 18) this.getByDayAndMonth(18, 'December');
          if (day === 19) this.getByDayAndMonth(19, 'December');
          if (day === 20) this.getByDayAndMonth(20, 'December');
          if (day === 21) this.getByDayAndMonth(21, 'December');
          if (day === 22) this.getByDayAndMonth(22, 'December');
          if (day === 23) this.getByDayAndMonth(23, 'December');
          if (day === 24) this.getByDayAndMonth(24, 'December');
          if (day === 25) this.getByDayAndMonth(25, 'December');
          if (day === 26) this.getByDayAndMonth(26, 'December');
          if (day === 27) this.getByDayAndMonth(27, 'December');
          if (day === 28) this.getByDayAndMonth(28, 'December');
          if (day === 29) this.getByDayAndMonth(29, 'December');
          if (day === 30) this.getByDayAndMonth(30, 'December');
          if (day === 31) this.getByDayAndMonth(31, 'December');
        }, err => {
          console.log(err);
        });
      } else {
  ...
  getCategories() {
    this.taskService.getCategoriesByMonth('December').subscribe(res => {
      if (!res.message) {
