...
@Component({
  selector: 'app-september-calendar',
  templateUrl: './september-calendar.component.html',
  styleUrls: ['./september-calendar.component.css'],
  providers: [TaskService]
})
export class SeptemberCalendarComponent implements OnInit {
  day_1: Array<Object> = [];
  day_2: Array<Object> = [];
  day_3: Array<Object> = [];
  day_4: Array<Object> = [];
  ...
  ngOnInit(): void {
    this.getCategories();
    this.actualDay();
    this.getByDayAndMonth(1, 'September');
    this.getByDayAndMonth(2, 'September');
    this.getByDayAndMonth(3, 'September');
    this.getByDayAndMonth(4, 'September');
    this.getByDayAndMonth(5, 'September');
    this.getByDayAndMonth(6, 'September');
    this.getByDayAndMonth(7, 'September');
    this.getByDayAndMonth(8, 'September');
    this.getByDayAndMonth(9, 'September');
    this.getByDayAndMonth(10, 'September');
    this.getByDayAndMonth(11, 'September');
    this.getByDayAndMonth(12, 'September');
    this.getByDayAndMonth(13, 'September');
    this.getByDayAndMonth(14, 'September');
    this.getByDayAndMonth(15, 'September');
    this.getByDayAndMonth(16, 'September');
    this.getByDayAndMonth(17, 'September');
    this.getByDayAndMonth(18, 'September');
    this.getByDayAndMonth(19, 'September');
    this.getByDayAndMonth(20, 'September');
    this.getByDayAndMonth(21, 'September');
    this.getByDayAndMonth(22, 'September');
    this.getByDayAndMonth(23, 'September');
    this.getByDayAndMonth(24, 'September');
    this.getByDayAndMonth(25, 'September');
    this.getByDayAndMonth(26, 'September');
    this.getByDayAndMonth(27, 'September');
    this.getByDayAndMonth(28, 'September');
    this.getByDayAndMonth(29, 'September');
    this.getByDayAndMonth(30, 'September');
  }
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.taskService.deleteTask(id).subscribe(res => {
          ...
          // All days.. Again
          if (day === 1) this.getByDayAndMonth(1, 'September');
          if (day === 2) this.getByDayAndMonth(2, 'September');
          if (day === 3) this.getByDayAndMonth(3, 'September');
          if (day === 4) this.getByDayAndMonth(4, 'September');
          if (day === 5) this.getByDayAndMonth(5, 'September');
          if (day === 6) this.getByDayAndMonth(6, 'September');
          if (day === 7) this.getByDayAndMonth(7, 'September');
          if (day === 8) this.getByDayAndMonth(8, 'September');
          if (day === 9) this.getByDayAndMonth(9, 'September');
          if (day === 10) this.getByDayAndMonth(10, 'September');
          if (day === 11) this.getByDayAndMonth(11, 'September');
          if (day === 12) this.getByDayAndMonth(12, 'September');
          if (day === 13) this.getByDayAndMonth(13, 'September');
          if (day === 14) this.getByDayAndMonth(14, 'September');
          if (day === 15) this.getByDayAndMonth(15, 'September');
          if (day === 16) this.getByDayAndMonth(16, 'September');
          if (day === 17) this.getByDayAndMonth(17, 'September');
          if (day === 18) this.getByDayAndMonth(18, 'September');
          if (day === 19) this.getByDayAndMonth(19, 'September');
          if (day === 20) this.getByDayAndMonth(20, 'September');
          if (day === 21) this.getByDayAndMonth(21, 'September');
          if (day === 22) this.getByDayAndMonth(22, 'September');
          if (day === 23) this.getByDayAndMonth(23, 'September');
          if (day === 24) this.getByDayAndMonth(24, 'September');
          if (day === 25) this.getByDayAndMonth(25, 'September');
          if (day === 26) this.getByDayAndMonth(26, 'September');
          if (day === 27) this.getByDayAndMonth(27, 'September');
          if (day === 28) this.getByDayAndMonth(28, 'September');
          if (day === 29) this.getByDayAndMonth(29, 'September');
          if (day === 30) this.getByDayAndMonth(30, 'September');
        }, err => {
          console.log(err);
        });
      } else {
  ...
  getCategories() {
    this.taskService.getCategoriesByMonth('September').subscribe(res => {
      if (!res.message) {
