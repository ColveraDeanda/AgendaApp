...
@Component({
  selector: 'app-november-calendar',
  templateUrl: './november-calendar.component.html',
  styleUrls: ['./november-calendar.component.css'],
  providers: [TaskService]
})
export class NovemberCalendarComponent implements OnInit {
  day_1: Array<Object> = [];
  day_2: Array<Object> = [];
  day_3: Array<Object> = [];
  day_4: Array<Object> = [];
  ...
  ngOnInit(): void {
    this.getCategories();
    this.actualDay();
    this.getByDayAndMonth(1, 'November');
    this.getByDayAndMonth(2, 'November');
    this.getByDayAndMonth(3, 'November');
    this.getByDayAndMonth(4, 'November');
    this.getByDayAndMonth(5, 'November');
    this.getByDayAndMonth(6, 'November');
    this.getByDayAndMonth(7, 'November');
    this.getByDayAndMonth(8, 'November');
    this.getByDayAndMonth(9, 'November');
    this.getByDayAndMonth(10, 'November');
    this.getByDayAndMonth(11, 'November');
    this.getByDayAndMonth(12, 'November');
    this.getByDayAndMonth(13, 'November');
    this.getByDayAndMonth(14, 'November');
    this.getByDayAndMonth(15, 'November');
    this.getByDayAndMonth(16, 'November');
    this.getByDayAndMonth(17, 'November');
    this.getByDayAndMonth(18, 'November');
    this.getByDayAndMonth(19, 'November');
    this.getByDayAndMonth(20, 'November');
    this.getByDayAndMonth(21, 'November');
    this.getByDayAndMonth(22, 'November');
    this.getByDayAndMonth(23, 'November');
    this.getByDayAndMonth(24, 'November');
    this.getByDayAndMonth(25, 'November');
    this.getByDayAndMonth(26, 'November');
    this.getByDayAndMonth(27, 'November');
    this.getByDayAndMonth(28, 'November');
    this.getByDayAndMonth(29, 'November');
    this.getByDayAndMonth(30, 'November');
  }
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.taskService.deleteTask(id).subscribe(res => {
          ...
          // All days.. Again
          if (day === 1) this.getByDayAndMonth(1, 'November');
          if (day === 2) this.getByDayAndMonth(2, 'November');
          if (day === 3) this.getByDayAndMonth(3, 'November');
          if (day === 4) this.getByDayAndMonth(4, 'November');
          if (day === 5) this.getByDayAndMonth(5, 'November');
          if (day === 6) this.getByDayAndMonth(6, 'November');
          if (day === 7) this.getByDayAndMonth(7, 'November');
          if (day === 8) this.getByDayAndMonth(8, 'November');
          if (day === 9) this.getByDayAndMonth(9, 'November');
          if (day === 10) this.getByDayAndMonth(10, 'November');
          if (day === 11) this.getByDayAndMonth(11, 'November');
          if (day === 12) this.getByDayAndMonth(12, 'November');
          if (day === 13) this.getByDayAndMonth(13, 'November');
          if (day === 14) this.getByDayAndMonth(14, 'November');
          if (day === 15) this.getByDayAndMonth(15, 'November');
          if (day === 16) this.getByDayAndMonth(16, 'November');
          if (day === 17) this.getByDayAndMonth(17, 'November');
          if (day === 18) this.getByDayAndMonth(18, 'November');
          if (day === 19) this.getByDayAndMonth(19, 'November');
          if (day === 20) this.getByDayAndMonth(20, 'November');
          if (day === 21) this.getByDayAndMonth(21, 'November');
          if (day === 22) this.getByDayAndMonth(22, 'November');
          if (day === 23) this.getByDayAndMonth(23, 'November');
          if (day === 24) this.getByDayAndMonth(24, 'November');
          if (day === 25) this.getByDayAndMonth(25, 'November');
          if (day === 26) this.getByDayAndMonth(26, 'November');
          if (day === 27) this.getByDayAndMonth(27, 'November');
          if (day === 28) this.getByDayAndMonth(28, 'November');
          if (day === 29) this.getByDayAndMonth(29, 'November');
          if (day === 30) this.getByDayAndMonth(30, 'November');
        }, err => {
          console.log(err);
        });
      } else {
  ...
  getCategories() {
    this.taskService.getCategoriesByMonth('November').subscribe(res => {
      if (!res.message) {
