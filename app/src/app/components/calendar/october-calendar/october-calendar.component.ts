...
@Component({
  selector: 'app-october-calendar',
  templateUrl: './october-calendar.component.html',
  styleUrls: ['./october-calendar.component.css'],
  providers: [TaskService]
})
export class OctoberCalendarComponent implements OnInit {
  day_1: Array<Object> = [];
  day_2: Array<Object> = [];
  day_3: Array<Object> = [];
  day_4: Array<Object> = [];
  ...
  ngOnInit(): void {
    this.getCategories();
    this.actualDay();
    this.getByDayAndMonth(1, 'October');
    this.getByDayAndMonth(2, 'October');
    this.getByDayAndMonth(3, 'October');
    this.getByDayAndMonth(4, 'October');
    this.getByDayAndMonth(5, 'October');
    this.getByDayAndMonth(6, 'October');
    this.getByDayAndMonth(7, 'October');
    this.getByDayAndMonth(8, 'October');
    this.getByDayAndMonth(9, 'October');
    this.getByDayAndMonth(10, 'October');
    this.getByDayAndMonth(11, 'October');
    this.getByDayAndMonth(12, 'October');
    this.getByDayAndMonth(13, 'October');
    this.getByDayAndMonth(14, 'October');
    this.getByDayAndMonth(15, 'October');
    this.getByDayAndMonth(16, 'October');
    this.getByDayAndMonth(17, 'October');
    this.getByDayAndMonth(18, 'October');
    this.getByDayAndMonth(19, 'October');
    this.getByDayAndMonth(20, 'October');
    this.getByDayAndMonth(21, 'October');
    this.getByDayAndMonth(22, 'October');
    this.getByDayAndMonth(23, 'October');
    this.getByDayAndMonth(24, 'October');
    this.getByDayAndMonth(25, 'October');
    this.getByDayAndMonth(26, 'October');
    this.getByDayAndMonth(27, 'October');
    this.getByDayAndMonth(28, 'October');
    this.getByDayAndMonth(29, 'October');
    this.getByDayAndMonth(30, 'October');
    this.getByDayAndMonth(31, 'October');
  }
    ...
    Swal.fire({
      ...
      if (result.value) {
        this.taskService.deleteTask(id).subscribe(res => {
          ...
          // All days.. Again
          if (day === 1) this.getByDayAndMonth(1, 'October');
          if (day === 2) this.getByDayAndMonth(2, 'October');
          if (day === 3) this.getByDayAndMonth(3, 'October');
          if (day === 4) this.getByDayAndMonth(4, 'October');
          if (day === 5) this.getByDayAndMonth(5, 'October');
          if (day === 6) this.getByDayAndMonth(6, 'October');
          if (day === 7) this.getByDayAndMonth(7, 'October');
          if (day === 8) this.getByDayAndMonth(8, 'October');
          if (day === 9) this.getByDayAndMonth(9, 'October');
          if (day === 10) this.getByDayAndMonth(10, 'October');
          if (day === 11) this.getByDayAndMonth(11, 'October');
          if (day === 12) this.getByDayAndMonth(12, 'October');
          if (day === 13) this.getByDayAndMonth(13, 'October');
          if (day === 14) this.getByDayAndMonth(14, 'October');
          if (day === 15) this.getByDayAndMonth(15, 'October');
          if (day === 16) this.getByDayAndMonth(16, 'October');
          if (day === 17) this.getByDayAndMonth(17, 'October');
          if (day === 18) this.getByDayAndMonth(18, 'October');
          if (day === 19) this.getByDayAndMonth(19, 'October');
          if (day === 20) this.getByDayAndMonth(20, 'October');
          if (day === 21) this.getByDayAndMonth(21, 'October');
          if (day === 22) this.getByDayAndMonth(22, 'October');
          if (day === 23) this.getByDayAndMonth(23, 'October');
          if (day === 24) this.getByDayAndMonth(24, 'October');
          if (day === 25) this.getByDayAndMonth(25, 'October');
          if (day === 26) this.getByDayAndMonth(26, 'October');
          if (day === 27) this.getByDayAndMonth(27, 'October');
          if (day === 28) this.getByDayAndMonth(28, 'October');
          if (day === 29) this.getByDayAndMonth(29, 'October');
          if (day === 30) this.getByDayAndMonth(30, 'October');
          if (day === 31) this.getByDayAndMonth(31, 'October');
        }, err => {
          console.log(err);
        });
      } else {
  ...
  getCategories() {
    this.taskService.getCategoriesByMonth('October').subscribe(res => {
      if (!res.message) {
